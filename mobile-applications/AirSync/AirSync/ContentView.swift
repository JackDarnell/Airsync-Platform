...
#Preview {
    let measurement = LatencyMeasurement(latencyMs: 42, confidence: 0.92, detections: [])
    return ContentView(session: CalibrationSession.previewSession(measurement: measurement))
}
